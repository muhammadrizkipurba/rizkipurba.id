      ...
      <BaseLayout withHero={true} page="terms-and-conditions">
        <div className="main" style={{padding: '0 15px'}}>
          <div className='mb-5'>
            ...
            <div className='mt-2'>
              <h3 className='mt-3'>2. Definitions</h3>
              <p className='mb-0 fs-16'>For the purposes of these Terms and Conditions:</p>
              <ul>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Cookie</strong> means a small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.
                  </p>
                </li>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Affiliate</strong> means an entity that controls, is
                ...
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Country</strong> refers to: Indonesia
                  </p>
                </li>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Company</strong> (referred to as either &quot;the
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
                    this Agreement) refers to Muhammad Rizki Purba.
                  </p>
                </li>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Device</strong> means any device that can access the Service
                    such as a computer, a cellphone or a digital tablet.
                  </p>
                </li>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Service</strong> refers to the Website.
                  </p>
                </li>
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Terms and Conditions</strong> (also referred as
                ...
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Third-party Social Media Service</strong> means any services
                ...
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- Website</strong> refers to Muhammad Rizki Purba, accessible
                    from{" "}
                    <a
                      href="https://rizkipurba.id"
                ...
                <li>
                  <p className='mb-0 fs-16'>
                    <strong className='font-w700'>- You</strong> means the individual accessing or using the
          ...
          <div className='mb-5'>
            ...
            <p className='fs-16'>
              ...
              any such web sites or services. We strongly advise You to read the terms and conditions and privacy
          ...
          <div className='mb-0'>
            ...
            <ul>
              <li>
                <p className='mb-0 fs-16'>By email: muhammadrizkipurba7@gmail.com</p>
              </li>
              <li>
                <p className='mb-0 fs-16'>
                  By visiting this page on Our website:{" "}
                  <a
                    href="https://rizkipurba.id/contact"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://rizkipurba.id/contact
                  </a>
                </p>
              </li>
              <li>
                <p className='mb-0 fs-16'>By phone number: 6282167472511</p>
              </li>
            </ul>
          </div>
